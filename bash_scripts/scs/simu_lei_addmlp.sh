...
singularity exec ~/jin/singularity_containers/dg-cite_latest.sif python -u ../python_scripts/simu_lei_addmlp.py --setting setting${2} --d ${3} --n 3000 --epoch 4000  --lr ${1}
