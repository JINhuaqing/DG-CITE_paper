...
singularity exec ~/jin/singularity_containers/dg-cite_latest.sif python -u ../python_scripts/run_ddpm_ablation_PCP_fixed.py --setting setting${1} --d $d --n 3000 --epoch $4 --early_stop $3
