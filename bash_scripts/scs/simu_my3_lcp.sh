...
singularity exec ~/jin/singularity_containers/dg-cite_latest.sif python -u ../python_scripts/simu_my3_lcp.py --setting setting7 --d 10 --n 3000 --epoch 4000 --n_T 400 --lr 0.01
