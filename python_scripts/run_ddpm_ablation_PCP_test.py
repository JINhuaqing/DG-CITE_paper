...
if params.ddpm_training.early_stop:
    params.save_dir = f"simu_ablation_{setting}fixed_d{params.simu_setting.d}_n{params.simu_setting.n}"
else:
    params.save_dir = f"simu_ablation_{setting}fixed_d{params.simu_setting.d}_n{params.simu_setting.n}_noearly"
