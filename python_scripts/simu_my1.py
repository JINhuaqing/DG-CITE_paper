...
from data_gen_utils.data_gen_my1 import get_simu_data
...
params.ddpm_training.test_intv = 100
...
params.prefix = ""
params.save_dir = f"simu_my1{setting}_d{params.simu_setting.d}_n{params.simu_setting.n}"
